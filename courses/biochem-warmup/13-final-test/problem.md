...
Use the whole-course pattern: identify the chemical feature, reason about the environment, then decide whether the interaction or mutation is likely to stabilize, destabilize, accelerate, slow, or change specificity.

Correctness and explanations are held until the results screen.
