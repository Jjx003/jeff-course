...
**Theorem 1 (Transitivity):** For any integers $a, b, c$, if $a \mid b$ and $b \mid c$, then $a \mid c$.
...
**Theorem 2 (Linear Combinations):** For any integers $a, b, c, x, y$, if $a \mid b$ and $a \mid c$, then $a \mid (bx + cy)$.
