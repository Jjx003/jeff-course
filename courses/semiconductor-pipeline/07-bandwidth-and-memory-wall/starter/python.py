"""
Roofline and HBM sizing helpers for AI accelerators.

Fill in the four TODO functions, then run the script. The expected output in
problem.md is exact.
"""
...
def arithmetic_intensity(flops: float, bytes_moved: float) -> float:
    ...
    # TODO: Validate bytes_moved and compute flops / bytes_moved.
...
def roofline_tflops(
    ...
    # TODO: Compute the bandwidth roof and cap it at peak_tflops.
    raise NotImplementedError
...
def hbm_capacity_for_model(
    ...
    # TODO: Convert billions of parameters to bytes, add overhead, return GB.
    raise NotImplementedError
...
def token_kv_cache_gb(
    ...
    # TODO: layers * keys/values * hidden size * sequence length * bytes.
    raise NotImplementedError
