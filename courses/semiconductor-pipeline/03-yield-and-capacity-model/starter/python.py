...
def die_per_wafer(wafer_diameter_mm: float, die_area_mm2: float) -> int:
    ...
    # TODO: use the wafer-area term minus the edge-loss term from the theory.
...
def poisson_yield(die_area_mm2: float, defect_density_per_cm2: float) -> float:
    ...
    # TODO: convert mm^2 to cm^2, then use exp(-lambda).
    raise NotImplementedError
...
def good_die_per_month(
    ...
    # TODO: combine wafers, dies per wafer, and Poisson yield.
    raise NotImplementedError
...
def bottleneck_capacity(step_capacities: dict[str, int]) -> tuple[str, int]:
    ...
    # TODO: return a (step_name, capacity) tuple for the smallest capacity.
    raise NotImplementedError
